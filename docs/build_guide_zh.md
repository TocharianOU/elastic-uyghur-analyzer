...
插件 ZIP 文件将在 `build/distributions/uyghur-analyzer-plugin-2.2.0-es8.zip` 创建。
...
Elasticsearch 9.x 插件 ZIP 文件将在 `build/distributions/uyghur-analyzer-plugin-2.2.0-es9.zip` 创建。
