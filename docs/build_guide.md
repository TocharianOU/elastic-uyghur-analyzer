...
The plugin ZIP file will be created at `build/distributions/uyghur-analyzer-plugin-2.5.0-es8.zip`.
...
The Elasticsearch 9.x plugin ZIP file will be created at `build/distributions/uyghur-analyzer-plugin-2.5.0-es9.zip`.
