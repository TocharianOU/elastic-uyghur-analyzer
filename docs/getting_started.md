...
Use `uyghur-analyzer-plugin-2.4.0-es8.zip` for Elasticsearch 8.x and `uyghur-analyzer-plugin-2.4.0-es9.zip` for Elasticsearch 9.x.
...
1. **Install the plugin**:
   ...
   # Elasticsearch 9.x
   elasticsearch-plugin install file:///path/to/uyghur-analyzer-plugin-2.4.0-es9.zip
   ```
...
2. **Copy the plugin to the container and install it**:
   ...
   docker exec -it -u root es elasticsearch-plugin install file:///tmp/uyghur-analyzer-plugin-2.4.0-es8.zip
   ```
