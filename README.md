...
- `uyghur-analyzer-plugin-2.2.0-es8.zip` for Elasticsearch 8.x
- `uyghur-analyzer-plugin-2.2.0-es9.zip` for Elasticsearch 9.x

## Version Compatibility

| Plugin Version | Elasticsearch Version | Release Date | Key Features |
|---------------|----------------------|--------------|--------------|
| 2.2.0-es8 | Elasticsearch 8.x, built against 8.7.0 stable plugin API; smoke-tested on 8.7.0 and 8.19.15 | 2026-05 | Weighted morphology model, Viterbi decoding, OOV suffix-boundary fallback |
| 2.2.0-es9 | Elasticsearch 9.x, built against 9.4.0 stable plugin API; smoke-tested on 9.4.0 | 2026-05 | Weighted morphology model, Viterbi decoding, OOV suffix-boundary fallback |
...
The built plugin will be available at `build/distributions/uyghur-analyzer-plugin-2.2.0-es8.zip`
...
The Elasticsearch 9.x plugin will be available at `build/distributions/uyghur-analyzer-plugin-2.2.0-es9.zip`.
