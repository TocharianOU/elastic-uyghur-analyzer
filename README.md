...
- `uyghur-analyzer-plugin-2.5.0-es8.zip` for Elasticsearch 8.x
- `uyghur-analyzer-plugin-2.5.0-es9.zip` for Elasticsearch 9.x

## Version Compatibility

| Plugin Version | Elasticsearch Version | Release Date | Key Features |
|---------------|----------------------|--------------|--------------|
| 2.5.0-es8 | Elasticsearch 8.x, built against 8.7.0 stable plugin API; smoke-tested on 8.7.0 and 8.19.15 | 2026-05 | Vowel-harmony canonical suffix restoration, THUUyMorph suffix normalization, morphology logic notes |
| 2.5.0-es9 | Elasticsearch 9.x, built against 9.4.0 stable plugin API; smoke-tested on 9.4.0 | 2026-05 | Vowel-harmony canonical suffix restoration, THUUyMorph suffix normalization, morphology logic notes |
...
1. Download the latest plugin:
   ```bash
   # Elasticsearch 8.x
   wget https://github.com/TocharianOU/elastic-uyghur-analyzer/releases/download/v2.5.0/uyghur-analyzer-plugin-2.5.0-es8.zip

   # Elasticsearch 9.x
   wget https://github.com/TocharianOU/elastic-uyghur-analyzer/releases/download/v2.5.0/uyghur-analyzer-plugin-2.5.0-es9.zip
   ```

2. Install to Elasticsearch:
   ```bash
   # Install the matching plugin from a local file
   elasticsearch-plugin install file:///path/to/uyghur-analyzer-plugin-2.5.0-es8.zip

   # Or install directly from URL for Elasticsearch 8.x
   elasticsearch-plugin install https://github.com/TocharianOU/elastic-uyghur-analyzer/releases/download/v2.5.0/uyghur-analyzer-plugin-2.5.0-es8.zip

   # Or install directly from URL for Elasticsearch 9.x
   elasticsearch-plugin install https://github.com/TocharianOU/elastic-uyghur-analyzer/releases/download/v2.5.0/uyghur-analyzer-plugin-2.5.0-es9.zip
   ```
...
2. Install the built plugin:
   ```bash
   elasticsearch-plugin install file:///path/to/build/distributions/uyghur-analyzer-plugin-2.5.0-es8.zip
   ```
...
The built plugin will be available at `build/distributions/uyghur-analyzer-plugin-2.5.0-es8.zip`
...
The Elasticsearch 9.x plugin will be available at `build/distributions/uyghur-analyzer-plugin-2.5.0-es9.zip`.
